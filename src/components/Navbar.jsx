...
import logo from '../../src/components/images/image1.jpg';
        ...
        return (
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                <div className="container-fluid">
                    <Link to="/home"> <img src={logo} alt="logo" style={{width:"70%", height:"50px",borderRadius:"10px"}}/></Link>
                    <Link className="navbar-brand" to="/home">Bijapur Info</Link>
